...
export const lang = {
  ...
  automated_handling_description:"L'action sera automatiquement executée au prochain raffraichissement des données (toutes les 30 minutes) lorsqu'au moins un des ensembles de conditions ci-dessous satisfait",
  ...
  action_manage_description: "Activer ou désactiver l'action. Lorsque l'action est désactivée, elle reste éteinte et ne pourra plus être allumée soit par la gestion automatique ou manuelle, à moins d'être réactivée à nouveau",
  enable: "Activer",
  disable: "Désactiver",
  once: "Une fois",
  "1m": "Pendant 1 minute",
  ...
  system_modules_description:"Aperçu des modules configurés. Pour connecter un nouveau module, ajoutez-le au réseau local et récupérer son addresse MAC et son addresse IP pour l'enregistrer dans le fichier de configuration /gardenia/settings.jsonc puis redémarrez le service ou redémarrer le serveur",
