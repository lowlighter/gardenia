...
export const lang = {
  ...
  system_autologout: "Déconnexion automatique après (en jours)",
  system_public: "Visibilité publique",
  system_public_stats: "Données et graphes météo publiques",
  system_public_actions: "État des actionneurs publics",
  system_public_history: "Historique public (les noms d'utilisateurs resteront masqués)",
  system_public_images: "Images publiques",
